                    ...
                    <tr>
                        ...
                        <td>
                            <form action="kelola.php?ubah=<?= $result['id'] ?>" class="form-inline" method="post">
                                ...
                                <button class="btn btn-success btn-sm mb-1"><i class="fa fa-edit"></i></button>
                            </form>
                            <a href="proses.php?hapus=<?= $result['id'] ?>" type="button"  class="btn btn-danger btn-sm" onclick="return confirm('hapus data?')"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
